...
// node_modules/@oddbird/css-anchor-positioning/dist/css-anchor-positioning.js
...
var On = (t, e, n) => e in t ? bo(t, e, { enumerable: true, configurable: true, writable: true, value: n }) : t[e] = n;
var U = (t, e) => {
  for (var n in e || (e = {}))
...
var id = To((fe) => {
  ...
  function Dr(t) {
    return Ie() ? t instanceof Node || t instanceof it(t).Node : false;
  }
  function ct(t) {
    return Ie() ? t instanceof Element || t instanceof it(t).Element : false;
  }
  function yt(t) {
    return Ie() ? t instanceof HTMLElement || t instanceof it(t).HTMLElement : false;
  }
  function Ln(t) {
    return !Ie() || typeof ShadowRoot == "undefined" ? false : t instanceof ShadowRoot || t instanceof it(t).ShadowRoot;
  }
  ...
  function Sn(t) {
    ...
    return _o.some((r) => n[r] ? n[r] !== "none" : false) || (n.containerType ? n.containerType !== "normal" : false) || !e && (n.backdropFilter ? n.backdropFilter !== "none" : false) || !e && (n.filter ? n.filter !== "none" : false) || No.some((r) => (n.willChange || "").includes(r)) || Do.some((r) => (n.contain || "").includes(r));
  }
  function Fo(t) {
    let e = Lt(t);
    for (; yt(e) && !Qt(e); ) {
  ...
  function Bo(t, e, n) {
    return e === void 0 && (e = false), !n || e && n !== it(t) ? false : e;
  }
  function Dt(t, e, n, r) {
  ...
  function Uo(t) {
    ...
    const o = s === "fixed", a = bt(r), l = e ? _e(e.floating) : false;
    if (r === a || l && o)
      return n;
    let u = {
      scrollLeft: 0,
  ...
  function Go(t, e) {
    const n = Dt(t, true, e === "fixed"), r = n.top + t.clientTop, s = n.left + t.clientLeft, o = yt(t) ? qt(t) : St(1), a = t.clientWidth * o.x, l = t.clientHeight * o.y, u = s * o.x, i = r * o.y;
    return {
      width: a,
      height: l,
      x: u,
  ...
  function Ur(t, e) {
    const n = Lt(t);
    return n === e || !ct(n) || Qt(n) ? false : ut(n).position === "fixed" || Ur(n, e);
  }
  function qo(t, e) {
    const n = e.get(t);
    if (n)
      return n;
    let r = le(t, [], false).filter((l) => ct(l) && te(l) !== "body"), s = null;
  ...
  function Yo(t, e, n) {
    const r = yt(e), s = bt(e), o = n === "fixed", a = Dt(t, true, o, e);
    let l = {
      scrollLeft: 0,
      scrollTop: 0
    };
  ...
  function Zo(t, e) {
    ...
    function a(l, u) {
      l === void 0 && (l = false), u === void 0 && (u = 1), o();
      ...
      function et(w) {
        ...
        if (C !== u) {
          if (!M)
            return a();
          C ? a(false, C) : r = setTimeout(() => {
            a(false, 1e-7);
          }, 1e3);
        }
        C === 1 && !zr(i, t.getBoundingClientRect()) && a(), M = false;
      }
      try {
  ...
  function je(t, e, n) {
    return t === 45 ? $e(e) || e === 45 || kt(e, n) : $e(t) ? true : t === 92 ? kt(t, e) : false;
  }
  function Be(t, e, n) {
  ...
  function Dn(t) {
    ...
    s[n] = a, o[n] = l, t.lines = s, t.columns = o, t.computed = true;
  }
  class ha {
    constructor(e, n, r, s) {
    ...
    setSource(e = "", n = 0, r = 1, s = 1) {
      this.source = e, this.startOffset = n, this.startLine = r, this.startColumn = s, this.computed = false;
    }
    getLocation(e, n) {
  ...
  class fa {
    ...
    next() {
      ...
      e < this.tokenCount ? (this.tokenIndex = e, this.tokenStart = this.tokenEnd, e = this.offsetAndType[e], this.tokenType = e >> gt, this.tokenEnd = e & dt) : (this.eof = true, this.tokenIndex = this.tokenCount, this.tokenType = vt, this.tokenStart = this.tokenEnd = this.source.length);
    }
    skipSC() {
  ...
  function ga(t, e) {
    ...
    for (let a = 0; a < t.length; a++) {
      ...
      if (l <= 31 || l === 127) {
        s += "\\" + l.toString(16), o = true;
        continue;
      }
      l === r || l === cn ? (s += "\\" + t.charAt(a), o = false) : (o && (Xt(l) || Ft(l)) && (s += " "), s += t.charAt(a), o = false);
    }
    return '"' + s + '"';
  }
  ...
  function xa(t) {
    ...
    for (let r = 0; r < t.length; r++) {
      ...
      if (s <= 31 || s === 127) {
        e += "\\" + s.toString(16), n = true;
        continue;
      }
      s === ma || s === un || s === ka || s === Sa || s === ya || s === es ? (e += "\\" + t.charAt(r), n = false) : (n && Xt(s) && (e += " "), e += t.charAt(r), n = false);
    }
    return "url(" + e + ")";
  }
  ...
  function Ca(t, e) {
    ...
    for (const s in n) {
      ...
      Array.isArray(o) || (o = [o]);
      for (const l of o)
        l === null ? a.nullable = true : typeof l == "string" ? a.type = "node" : Array.isArray(l) && (a.type = "list");
      a.type && r.push(a);
    }
    return r.length ? {
  ...
  function Un(t, e) {
    ...
    return e && n.reverse(), function(o, a, l, u) {
      ...
      for (const c of n) {
        ...
        if (!c.nullable || h) {
          if (c.type === "list") {
            if (e ? h.reduceRight(u, false) : h.reduce(u, false))
              return true;
          } else if (l(h))
            return true;
        }
  ...
  function Aa(t) {
    ...
    for (const i in e)
      wn.call(e, i) && e[i] !== null && (n[i] = Un(e[i], false), r[i] = Un(e[i], true));
    const a = Wn(n), l = Wn(r), u = function(i, c) {
      function h(S, x, T) {
        const M = f.call(k, S, x, T);
        return M === s ? true : M === o ? false : !!(g.hasOwnProperty(S.type) && g[S.type](S, k, h, m) || p.call(k, S, x, T) === s);
      }
  ...
  const mt = 43, rt = 45, xe = 110, It = true, Ta = false;
  function Ce(t, e) {
  ...
  function ss(t = false) {
    ...
    switch (this.eat(z), n = this.substrToCursor(e + 1), r = n.toLowerCase(), this.skipSC(), this.eof === false && this.tokenType !== ht && this.tokenType !== tt && (this.parseAtrulePrelude ? s = this.parseWithFallback(this.AtrulePrelude.bind(this, n, t), zn) : s = zn.call(this, this.tokenIndex), this.skipSC()), this.tokenType) {
      case tt:
        this.next();
        break;
      case ht:
  ...
  function os(t) {
    let e = null;
    return t !== null && (t = t.toLowerCase()), this.skipSC(), hasOwnProperty.call(this.atrule, t) && typeof this.atrule[t].prelude == "function" ? e = this.atrule[t].prelude.call(this) : e = this.readSequence(this.scope.AtrulePrelude), this.skipSC(), this.eof !== true && this.tokenType !== ht && this.tokenType !== tt && this.error("Semicolon or block is expected"), {
      type: "AtrulePrelude",
  ...
  const Fa = Object.freeze(Object.defineProperty({
    __proto__: null,
    generate: as,
    name: _a,
    parse: os,
  ...
  function Ua() {
    ...
    const t = this.tokenStart;
    let e = false;
    return this.isDelim(ls) ? (e = true, this.next()) : this.isDelim(hn) || this.eat(d), this.isDelim(hn) ? this.charCodeAt(this.tokenStart + 1) !== we ? (this.next(), this.eat(d)) : e && this.error("Identifier is expected", this.tokenEnd) : e && this.error("Vertical line is expected"), {
      type: "Identifier",
      loc: this.getLocation(t, this.tokenStart),
  ...
  const rl = Object.freeze(Object.defineProperty({
    __proto__: null,
    generate: ks,
    name: el,
    parse: ms,
  ...
  const xl = Object.freeze(Object.defineProperty({
    __proto__: null,
    generate: Ts,
    name: yl,
    parse: As,
  ...
  function _l() {
    ...
    return e.type !== "Raw" && this.eof === false && this.tokenType !== tt && this.isDelim($s) === false && this.isBalanceEdge(t) === false && this.error(), e;
  }
  ...
  function Os() {
    ...
    return this.isDelim($s) && (a = jl.call(this), this.skipSC()), this.eof === false && this.tokenType !== tt && this.isBalanceEdge(e) === false && this.error(), {
      type: "Declaration",
      loc: this.getLocation(t, this.tokenStart),
      important: a,
      property: n,
  ...
  function Ls(t) {
    this.token(d, t.property), this.token(X, ":"), this.node(t.value), t.important && (this.token(O, "!"), this.token(d, t.important === true ? "important" : t.important));
  }
  function Ml() {
    const t = this.tokenStart;
    if (this.tokenType === O)
    ...
    for (; !this.eof; )
      switch (this.tokenType) {
        ...
        case tt:
          ...
          break;
        case z:
          t.push(this.parseWithFallback(this.Atrule.bind(this, true), Ve));
          break;
        default:
  ...
  const oc = Object.freeze(Object.defineProperty({
    __proto__: null,
    generate: Bs,
    name: sc,
    parse: js,
  ...
  function zs(t) {
    ...
    const r = this.parseWithFallback(
      () => {
        ...
        return this.eof === false && this.isBalanceEdge(s) === false && this.error(), o;
      },
  ...
  const cu = Object.freeze(Object.defineProperty({
    __proto__: null,
    generate: bi,
    name: ou,
    parse: yi,
  ...
  function ku() {
    ...
    return t.type !== "Raw" && this.eof === false && this.tokenType !== ht && this.error(), t;
  }
  ...
  function Ti() {
    ...
    let n, r;
    return this.parseRulePrelude ? n = this.parseWithFallback(ku, tr) : n = tr.call(this, t), r = this.Block(true), {
      type: "Rule",
      loc: this.getLocation(e, this.tokenStart),
      prelude: n,
      block: r
  ...
  function qe() {
    this.tokenType !== d && this.isDelim(zu) === false && this.error("Identifier or asterisk is expected"), this.next();
  }
  ...
  function re(t, e) {
    ...
    for (let r = this.tokenStart + t; r < this.tokenEnd; r++) {
      ...
      if (s === Wi && e && n !== 0)
        return re.call(this, t + n + 1, false), -1;
      Xt(s) || this.error(
  ...
  function Ku() {
    ...
    switch (this.tokenType) {
      case b:
        if (t = re.call(this, 1, true), this.isDelim(fn)) {
          ke.call(this, 6 - t);
          break;
        }
        if (this.tokenType === E || this.tokenType === b) {
          qu.call(this, Wi), re.call(this, 1, false);
          break;
        }
        break;
      case E:
        t = re.call(this, 1, true), t > 0 && ke.call(this, 6 - t);
        break;
      default:
        if (this.eatDelim(Ui), this.tokenType === d) {
          t = re.call(this, 0, true), t > 0 && ke.call(this, 6 - t);
          break;
        }
        if (this.isDelim(fn)) {
  ...
  const ah = Object.freeze(Object.defineProperty({
    ...
    parse: Qi,
    structure: oh
  }, Symbol.toStringTag, { value: "Module" })), lh = Object.freeze(Object.defineProperty({
    __proto__: null,
    AnPlusB: $a,
    Atrule: Ia,
    AtrulePrelude: Fa,
  ...
  function mh(t) {
    ...
    t.node = function(f) {
      if (f.loc && f.loc.start && rr.has(f.type)) {
        ...
        (r.line !== p || r.column !== g) && (r.line = p, r.column = g, n.line = a, n.column = l, u && (u = false, (n.line !== s.line || n.column !== s.column) && e.addMapping(o)), u = true, e.addMapping({
          source: f.loc.source,
          original: r,
          generated: n
        }));
  ...
  function ro(t) {
    ...
    return function(n, r, s) {
      ...
      return (a === Sh && r !== d && r !== A && r !== nt || a === kh ? e.has(n << 16 | a << 8) : e.has(n << 16 | o)) && this.emit(" ", W, true), o;
    };
  }
  const bh = ro(no), so = ro(yh), sr = Object.freeze(Object.defineProperty({
    __proto__: null,
    safe: so,
    spec: bh
  ...
  function Ah(t) {
    ...
    return function(n, r) {
      let s = "", o = 0, a = {
        ...
        tokenBefore: so,
        token(u, i) {
          o = this.tokenBefore(o, u, i), this.emit(i, u, false), u === O && i.charCodeAt(0) === xh && this.emit(`
`, W, true);
        },
        emit(u) {
          s += u;
...
` + ar({ source: e, line: r, column: s, baseLine: o, baseColumn: a }, 2);
  ...
  function Oh(t) {
    ...
    for (; !this.eof; ) {
      ...
      if (s === void 0)
        break;
      n && (t.onWhiteSpace && t.onWhiteSpace.call(this, s, e, r), n = false), e.push(s);
    }
  ...
  function _h(t) {
    let e = "", n = "<unknown>", r = false, s = cr, o = false;
    const a = new ha(), l = Object.assign(new fa(), Ih(t || {}), {
      ...
      eatIdent(i) {
        (this.tokenType !== d || this.lookupValue(0, i) === false) && this.error(`Identifier "${i}" is expected`), this.next();
      },
      eatDelim(i) {
    ...
    return Object.assign(function(i, c) {
      e = i, c = c || {}, l.setSource(e, Jr), a.setSource(
        ...
        c.line,
        c.column
      ), n = c.filename || "<unknown>", r = !!c.positions, s = typeof c.onParseError == "function" ? c.onParseError : cr, o = false, l.parseAtrulePrelude = "parseAtrulePrelude" in c ? !!c.parseAtrulePrelude : true, l.parseRulePrelude = "parseRulePrelude" in c ? !!c.parseRulePrelude : true, l.parseValue = "parseValue" in c ? !!c.parseValue : true, l.parseCustomProperty = "parseCustomProperty" in c ? !!c.parseCustomProperty : false;
  ...
  function Zh() {
    ...
    if (this.skipSC(), t.push(this.Identifier()), this.skipSC(), this.tokenType === ft) {
      ...
      const e = this.tokenIndex, n = this.parseCustomProperty ? this.Value(null) : this.Raw(this.consumeUntilExclamationMarkOrSemicolon, false);
  ...
  function $f(t) {
    for (const e of t) {
      ...
      }), n && (e.css = Z(r), e.changed = true);
    }
    return t.some((e) => e.changed === true);
  }
  var lo = ((t) => (t.All = "all", t.None = "none", t))(lo || {});
  function ot(t, e) {
    var r;
...
`, "");
  ...
  function Np(t) {
    ...
    for (const s of t) {
      ...
      }), o && (s.css = Z(l), s.changed = true);
    }
    return { fallbackTargets: n, validPositions: r };
  }
  function Dp(t, e) {
    return !t || t === e ? false : So(t) ? t.document.contains(e) : t.contains(e);
  }
  function So(t) {
    return !!(t && t === t.window);
  }
  ...
  function Vp(t, e) {
    ...
    if ((Re(t) || kn(t)) && e) {
      ...
      if (Re(t) && ue(e.property) || kn(t) && to(e.property)) {
        const r = Er(t);
        return { prop: e.property, data: r, changed: true };
      }
    }
    return {};
  }
        ...
        for (const C of t) {
          ...
          $t(L, {
            ...
            enter(N) {
              ...
              if (($ == null ? void 0 : $.children.isEmpty) === false && Ae(N) && v && j && N.children.first && a.has(N.children.first.name) && // For now, we only want assignments to other CSS custom properties
              j.startsWith("--")) {
                ...
                const wt = l[j];
                wt.names.includes(J.name) || wt.names.push(J.name), wt.uuids.push(Ct), w.push(j), J.name = Ct, P = true;
              }
            }
          }), P && (C.css = Z(L), C.changed = true);
        }
      ...
      for (const w of t) {
        ...
        $t(P, {
          ...
          enter(L) {
            ...
            if ((N == null ? void 0 : N.children.isEmpty) === false && Ae(L) && $ && v && L.children.first && // Now we only want assignments to inset/sizing properties
            (ue(v) || Xi(v))) {
  ...
  function Lr(t, e, n = false) {
    const r = [];
    for (const { el: s, css: o, changed: a, created: l = false } of t) {
      const u = { el: s, css: o, changed: false };
      if (a) {
  ...
  const Kp = G(U({}, H), { _c: /* @__PURE__ */ new Map() }), Qp = (t, e) => {
    ...
    if (r !== void 0) {
      ...
      switch (r) {
        ...
        default:
          if (t) {
            const m = (yield (l = H.isRTL) == null ? void 0 : l.call(H, t)) || false;
            u = Qp(r, m);
          }
      }
      ...
      for (const s of r) {
        ...
        on(
          ...
          () => R(null, null, function* () {
            if (o)
              return;
            o = true, s.removeAttribute("data-anchor-polyfill");
            const l = yield _r(s, a);
            if (Object.values(l).every((u) => u <= 0)) {
              s.removeAttribute("data-anchor-polyfill-last-successful"), o = false;
              return;
            }
            for (const [u, { uuid: i }] of e.entries()) {
              ...
              if (Object.values(c).every((h) => h <= 0)) {
                s.setAttribute("data-anchor-polyfill-last-successful", i), o = false;
                break;
              }
              if (u === e.length - 1) {
                ...
                h ? s.setAttribute("data-anchor-polyfill", h) : s.removeAttribute("data-anchor-polyfill"), o = false;
                break;
              }
            }
          }),
          { animationFrame: n, layoutShift: false }
        );
      }
    });
  }
  function rd(t, e = false) {
    return R(this, null, function* () {
      var n, r;
  ...
  function Nr(t) {
    return R(this, null, function* () {
      ...
      return Object.values(r).length && (Lr(n, s, true), yield rd(r, e.useAnimationFrame)), r;
    });
  }
...
var css_anchor_positioning_default = id();
export {
  css_anchor_positioning_default as default
};
//# sourceMappingURL=css-anchor-positioning-LFVVGMDB.js.map
