...
-- ================================================================
-- PARTE 1: zeloutf.ocorrencias — acesso e políticas
-- ================================================================

-- 1. Liberar acesso ao schema zeloutf para anon e authenticated
...
-- 4. Policy SELECT — anon (feed público, leitura irrestrita)
...
-- 5. Policy SELECT — authenticated (gestão e usuários logados)
...
-- 6. Policy UPDATE — somente usuários com acesso à gestão
...
-- 7. Colunas de localização do relator (se não existirem)
...
-- ================================================================
-- PARTE 2: mover gestao_acesso de public → zeloutf
-- ================================================================

-- 8. Criar tabela zeloutf.gestao_acesso
...
-- 9. Copiar dados existentes de public.gestao_acesso (se houver)
...
-- 10. RLS e grants para zeloutf.gestao_acesso
